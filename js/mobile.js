    ...
    topbar.addEventListener('click', function (e) {
      ...
      if (target.classList.contains('toggle')) {
        ...
        if (wrap) {
          ...
          wrap.classList.contains('sandbox')
      ...
      if (target.classList.contains('notif-btn') || target.closest('.notif-btn')) {
        ...
        if (!dd) {
          ...
          dd.innerHTML =
            ...
            '<div class="notif-item"><div class="notif-item-icon amber"><i data-lucide="refresh-ccw" style="width:13px;height:13px;"></i></div><div class="notif-item-body"><div class="notif-item-text">Refund #RFD-033 requested</div><div class="notif-item-time">1 hr ago</div></div></div>' +
